...
export default function Footer({ navigate }) {
  return <footer className="footer">
    <div className="container footer-grid">
      ...
      <div><h4>روابط سريعة</h4><a href="/features" onClick={e=>{e.preventDefault();navigate('/features')}}>المميزات</a><a href="/services" onClick={e=>{e.preventDefault();navigate('/services')}}>خدمات الفريق</a><a href="/tutorials" onClick={e=>{e.preventDefault();navigate('/tutorials')}}>الشروحات</a><a href="/faq" onClick={e=>{e.preventDefault();navigate('/faq')}}>الأسئلة الشائعة</a></div>
